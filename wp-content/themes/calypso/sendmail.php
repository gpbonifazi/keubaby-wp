...
if($error == true){
	echo '<div class="alert alert-info"><button type="button" class="close" data-dismiss="alert">&times;</button>' . __('All fields are required.', THEME_LANGUAGE_DOMAIN). '</div><br/>';
}
...
if($error == false){
	...
	echo '<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">&times;</button>' . __('Your message has been sent.', THEME_LANGUAGE_DOMAIN). '</div><br/>';	
