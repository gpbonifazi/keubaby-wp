...
function my_theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'             => get_stylesheet_directory() . '/components/tgm/plugins/aqua-page-builder.zip', // The plugin source.
     ...
     */
    $config = array(
        'id'           => 'zolixtgmpa',                 // Unique ID for hashing notices for multiple instances of TGMPA.
